    ...
    <div>
      ...
      <div class="bg-gray-900 text-white font-inter">
        ...
        <section id="hero" class="relative h-screen">
          ...
          >
            <h2
              class="text-3xl sm:text-4xl md:text-6xl font-extrabold mb-6 animate-on-load"
            >
        ...
        <section id="services" class="py-20 bg-gray-800">
          <div
            class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center"
            v-animate-on-scroll
          >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div class="p-6 flex flex-col flex-grow">
                  ...
                  <span class="text-xl sm:text-2xl font-bold mt-auto">
                    ${{ service.price }}
                  </span>
                </div>
              </div>
        ...
        <section
          id="discounts"
          class="relative py-20 bg-center bg-cover parallax"
        ...
        <section id="gallery" class="py-20 bg-gray-900">
          <div
            class="container mx-auto px-4 sm:px-6 text-center"
            v-animate-on-scroll
          >
            ...
            <div
              class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 sm:gap-6 space-y-4 sm:space-y-6"
            >
              <img
        ...
        <section id="contact" class="py-20 bg-gray-800">
          <div
            class="container mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-8 sm:gap-12 items-center"
            v-animate-on-scroll
          >
            <!-- Form -->
            <div>
              ...
              <form class="space-y-4 sm:space-y-6">
                ...
                <button
                  type="submit"
                  class="bg-yellow-400 text-gray-900 font-bold py-3 px-6 sm:px-8 rounded-full shadow-lg hover:bg-yellow-300 hover:scale-105 transform transition"
                >
                  نامێ بهنێرە
                </button>
              </form>
