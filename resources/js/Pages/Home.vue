<template>
  <AppLayout title="سەرەکی">
    <div class="bg-gray-900 text-white font-inter">
      ...
      <!-- Hero Section -->
      <!-- ========================= -->
      <section id="hero" class="relative h-[80vh] md:h-screen">
        ...
        >
          <h2 class="text-3xl sm:text-5xl md:text-7xl font-extrabold mb-6 animate-on-load">
          ...
          <a
            href="#services"
            class="bg-yellow-400 text-gray-900 font-bold py-3 px-6 sm:px-10 rounded-full text-base sm:text-lg shadow-lg hover:bg-yellow-300 hover:scale-105 transform transition animate-on-load delay-2"
          >
            خزمەتێن مە ببینە
          </a>
        </div>
      ...
      <section id="services" class="py-16 sm:py-24 bg-gray-800">
        <div class="container mx-auto px-4 sm:px-6 text-center">
          <h2 class="text-3xl sm:text-4xl font-extrabold mb-4">
            خزمەتگوزاریێن شاهانە
          </h2>
          <p class="text-gray-300 max-w-2xl mx-auto mb-12 text-sm sm:text-base">
          ...
          >
            ...
            >
              ...
              <div class="p-4 sm:p-6 flex flex-col flex-grow">
                ...
                <p class="text-gray-300 mb-4 flex-grow text-sm sm:text-base">
                  {{ service.description }}
                </p>
                <span class="text-lg sm:text-2xl font-bold mt-auto"
                  >${{ service.price }}</span
                >
              </div>
            </div>
      ...
      <!-- Gallery Section -->
      <!-- ========================= -->
      <section id="gallery" class="py-16 sm:py-24 bg-gray-900">
        <div class="container mx-auto px-4 sm:px-6 text-center">
          <h2 class="text-3xl sm:text-4xl font-extrabold mb-12">
            پێشانگەها کارێن مە
          </h2>
          <div
            class="columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 sm:gap-6 space-y-4 sm:space-y-6"
          >
            <img
      ...
      <!-- Contact Section -->
      <!-- ========================= -->
      <section id="contact" class="py-16 sm:py-24 bg-gray-800">
        <div
        ...
        >
          ...
          <div>
            ...
            <form class="space-y-4 sm:space-y-6">
              <input
                ...
                class="w-full px-4 py-3 rounded-lg bg-gray-900 border border-gray-700 focus:ring-2 focus:ring-yellow-400 focus:outline-none transition text-sm sm:text-base"
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                class="bg-yellow-400 text-gray-900 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-yellow-300 hover:scale-105 transform transition text-sm sm:text-base"
              >
                نامێ بهنێرە
              </button>
            </form>
          ...
          <!-- Map -->
          <div class="rounded-xl overflow-hidden shadow-lg h-[350px] sm:h-[450px]">
            <iframe
              src="https://maps.google.com/maps?q=Zakho%20Iraq&t=&z=13&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="100%"
              style="border:0;"
              allowfullscreen=""
...
const services = [
  ...
  },
  {
    ...
    price: 150,
    image_url:
      "https://assets.usestyle.ai/496fa622-49b8-468b-b870-a80307da1859",
  },
];
