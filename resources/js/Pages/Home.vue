  ...
  <AppLayout title="سەرەکی">
    <div>
      ...
      <Transition name="fade">
        ...
        >
          <h1
            class="text-4xl sm:text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-yellow-400 to-yellow-200 text-transparent bg-clip-text tracking-wide animate-pulse"
          >
            LXMAN
          </h1>
        </div>
      ...
      <div class="bg-gray-900 text-white font-inter">
        ...
        <main>
          <!-- Hero -->
          <section id="hero" class="relative min-h-screen py-24 md:py-0">
            <div class="absolute inset-0">
              <div class="w-full h-full">
                <img
                  ...
                  :key="i"
                  :src="img"
                  class="absolute inset-0 w-full h-full object-cover object-center transition-opacity duration-[1500ms]"
            ...
            <div
              class="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-6"
            >
              <h2
                class="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold mb-6 animate-on-load"
              >
                ستایلێ خۆ <span class="text-yellow-400">نووژەن</span> بکە
              </h2>
              <p
                class="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto mb-8 animate-on-load delay-1"
              >
                ئێمە ل ڤێرێ نە دا کو باشترین خزمەتگوزاریێن سەرتراشین، ڕێکخستنا ڕهـ
                و گرنگیدان ب ستایلێ تە پێشکێش بکەین.
              </p>
              <a
                href="#services"
                class="bg-yellow-400 text-gray-900 font-bold py-3 px-8 sm:px-10 rounded-full text-base sm:text-lg shadow-lg hover:bg-yellow-300 hover:scale-105 transform transition animate-on-load delay-2"
              >
                خزمەتێن مە ببینە
              </a>
            </div>
          ...
          <!-- Services -->
          <section id="services" class="py-16 sm:py-20 md:py-24 bg-gray-800">
            <div class="container mx-auto px-4 sm:px-6 text-center" v-animate-on-scroll>
              <h2 class="text-3xl sm:text-4xl font-extrabold mb-4">خزمەتگوزاریێن شاهانە</h2>
              <p class="text-gray-300 max-w-2xl mx-auto mb-10 sm:mb-12">
              ...
              >
                ...
                >
                  ...
                  <div class="p-6 flex flex-col flex-grow">
                    <h3 class="text-xl sm:text-2xl font-bold text-yellow-400 mb-2">
                      {{ service.name }}
                    </h3>
                    <p class="text-gray-300 mb-4 flex-grow">{{ service.description }}</p>
                    <span class="text-xl sm:text-2xl font-bold mt-auto">${{ service.price }}</span>
                  </div>
                </div>
              </div>
            </div>
...
>
  ...
  >
    ...
    <p class="text-gray-200 text-base sm:text-lg md:text-xl mb-8">
    ...
    >
      ...
      >
        هەمی ئۆفەران ببینە
          ...
          <!-- Gallery -->
          <section id="gallery" class="py-16 sm:py-20 md:py-24 bg-gray-900">
            <div class="container mx-auto px-4 sm:px-6 text-center" v-animate-on-scroll>
              <h2 class="text-3xl sm:text-4xl font-extrabold mb-12">پێشانگەها کارێن مە</h2>
              <div
          ...
          <section id="contact" class="py-16 sm:py-20 md:py-24 bg-gray-800">
            <div
              class="container mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center"
              v-animate-on-scroll
            >
              <!-- Form -->
              <div>
                <h2 class="text-3xl sm:text-4xl font-extrabold mb-6">پەیوەندیێ ب مە بکە</h2>
              ...
              <!-- Map -->
              <div class="rounded-xl overflow-hidden shadow-lg h-[350px] sm:h-[400px] md:h-[450px]">
                <iframe
...
const services = [
  {
    ...
    description:
      "شۆشتنا پرچێ ب باشترین کەرەستەیان، دگەل مەساجەکا ئارامکەر بۆ سەری و ستایلکرنێ.",
    price: 15,
    image_url:
  ...
  },
  {
    ...
    description:
      "مەساجەکا پرۆفێشنال بۆ پشت و ملان کو هەستا ئارامیێ و ڕەحەتیێ ددەتە تە.",
    price: 40,
    image_url:
  ...
  },
  {
    ...
    description:
      "لابردنا مویێن زێدە یێن دەموچاڤا و ڕێکخستنا برهان ب شێوەیەکێ پاقژ و سەرنجڕاکێش.",
    price: 15,
    image_url:
  ...
  },
  {
    ...
    description:
      "هەر تشتێ زاڤا پێدڤی! سەرتاشین، خزمەتا دەموچاڤا، مەساج و ستایلکرنەکا شاهانە.",
    price: 150,
